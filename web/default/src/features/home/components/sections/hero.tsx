...
export function Hero(props: HeroProps) {
  ...
  return (
    <section className="relative z-10 overflow-hidden px-6 pt-24 pb-16 md:pt-32 md:pb-24 lg:pt-36 lg:pb-28">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 opacity-25 dark:opacity-[0.12] -scale-x-100"
        style={{
          background: [
            "radial-gradient(ellipse 54.3% 77.25% at 16.67% 64.23%, rgba(34, 197, 94, 0.40) 0%, rgba(34, 197, 94, 0.00) 70%)",
            "radial-gradient(ellipse 40% 50% at 80% 15%, rgba(0, 169, 179, 0.60) 30%, rgba(0, 169, 179, 0.00) 70%)",
            "radial-gradient(ellipse 35% 40% at 40% 80%, rgba(144, 149, 232, 0.40) 0%, rgba(144, 149, 232, 0.00) 70%)",
          ].join(", "),
        }}
      />
      {/* Grid pattern */}
